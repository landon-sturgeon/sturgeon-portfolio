  ...
  <div className="portfolio-app">
    ...
    <div className="navbar-wrapper">
      <nav className="navbar navbar-expand-lg navbar-dark fj-mw9">
        <a className="navbar-brand mr-3 font-weight-bold" href="#">LandonSturgeon</a>
    ...
    <section className="fj-hero">
      <div className="fj-hero-wrapper row">
        <div className="hero-left col-md-6">
          <h1 className="white hero-title">Hey I'm Landon. Experienced full stack developer</h1>
        ...
        <div className="list-group">
          <a href="#" className="list-group-item list-group-item-action flex-column align-items-start py-3 subtle-shadow no-border">
            ...
            <div className="avatar-container my-2">
              ...
              <span className="avatar-title">Landon Sturgeon</span>
            </div>
          </a>
                      ...
                      <div className="topic-header">
                        <div className="topic-meta">
                          <div className="name-container">
                            <span className="name">Landon Sturgeon</span>
                          </div>
